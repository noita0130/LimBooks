// components/StoryList.jsx (개선된 버전)
      ...
      {stories[storyType].map((story, index) => (
        <motion.div
          ...
          className={`${backgroundTransition} ${
            darkMode ? 'bg-neutral-800 hover:bg-neutral-700' : 'bg-white hover:bg-neutral-300'
          ...
          <div className="flex flex-col md:flex-row md:items-center md:space-x-8">
            ...
            <div className="flex-1">
              <div className="flex justify-between items-center">
                <h2 className={`text-lg md:text-xl font-semibold mb-2 pr-2 ${getTextStyle(darkMode)}`}>
                  {story.title}
                </h2>
                <ChevronRight className={`w-5 h-5 ${textTransition} ${darkMode ? 'text-neutral-400' : 'text-neutral-600'}`} />
              </div>
              <p className={`${getSubTextStyle(darkMode)} text-sm md:text-base`}>
