// components/PersonalityVoiceContent.jsx (개선된 버전)
...
const PersonalityVoiceContent = () => {
  ...
  const {
    ...
    handleStopAudio,
    handleVolumeChange
  } = useAudioPlayer(AUDIO_PATHS.PERSONALITY);
  ...
  // 대사 텍스트 스타일
  const getQuoteTextStyle = () => `whitespace-pre-wrap leading-relaxed text-sm md:text-base ${textTransition}
