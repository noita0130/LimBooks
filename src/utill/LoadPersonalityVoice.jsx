...
const LoadPersonalityVoice = async (personalityId, storyId) => {
  try {
    ...
    // 동적 import 사용
    const voiceModule = await import(`../story/personality/voice/${storyId}.json`);
    console.log("대사집 모듈 로드 성공");
    
    // import된 데이터 가져오기
    const data = voiceModule.default;
    ...
    return {
      ...
      quotes: [
        {
          situation: '오류 발생',
          text: '대사집 데이터를 불러오는데 문제가 발생했습니다.',
          category: '시스템'
        }
      ],
      personalityId: personalityId
